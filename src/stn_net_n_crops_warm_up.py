...
class CNN(object):
    def __init__(self, config):
        ...
        subdir = date_time + '_stn_warm_up_v3_' + hyper_params # this version uses inception v3 frozen
    ...
    def add_training_op(self, loss):
        with tf.name_scope('optimizer'):
            ...
            out_vars = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope='classifier/final_out')
            optimizer_localizer = tf.train.GradientDescentOptimizer(self.lr * 1e-2)
